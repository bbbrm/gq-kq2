    ...
    layui.use('table', function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                ,{field: 'post', title: '岗位名称', width:80}
                ,{field: 'department', title: '所在部门', width:80}
                ,{field: 'superior', title: '直接上级', width:80}
                ,{field: 'jobCategory', title: '岗位类别', width:80}
                ,{field: 'describe', title: '岗位职责描述', width:80}
