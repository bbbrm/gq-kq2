    ...
    layui.use('table', function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                ,{field: 'emp_umber', title: '员工编码', width:80}
                ,{field: 'emp_name', title: '姓名', width:80}
                ,{field: 'sex', title: '性别', width:80}
                ,{field: 'age', title: '年龄', width:80}
                ,{field: 'nation', title: '民族', width:80}
                ,{field: 'identity_card', title: '身份证', width:80}
                ,{field: 'pay', title: '薪水', width:80}
                ,{field: 'phone', title: '联系电话', width:80}
                ,{field: 'eme_contact', title: '紧急联系人', width:80}
                ,{field: 'eme_phone', title: '紧急联系人电话', width:80}
                ,{field: 'post_id', title: '岗位', width:80}
                ,{field: 'personal_profile', title: '个人描述', width:80}
